...
export default function TreeNode({ node, depth, effective, isSelected, isHighlighted, isOpen, onSelect, onToggle, reload, refreshNode, byId, onSetStatus, onAddTag, whenChildrenCount }) {
